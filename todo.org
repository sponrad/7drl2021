...
* DONE bug when killing small enemy with firebolt (on android)
* DONE bug killing end boss (on macos and android)
...
* DONE game name etc
* DONE desummon when mana is about to go negative!
